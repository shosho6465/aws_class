...
public class CommentService2 {
	...
	public String deleteComment(int coNum, CustomUser user) {
		//로그인한 사용자가 아니면 로그인리 피룡한 서비스입니다라고 반환
		if(user == null || user.getUsername() == null) {
			return "로그인이 필요한 서비스입니다.";
		}
		
		//작성자인지 확인
		if(isWritter(coNum, user)) {
			return "작성자가 아닙니다.";
		}
	...
	public String updateComment(CommentDTO dto, CustomUser user) {
		...
		//작성자인지 확인
		if(!isWritter(dto.getCoNum(), user)) {
			return "작성자가 아닙니다.";
		}
	...
	private boolean isWritter(int coNum, CustomUser user) {
		if(user == null || user.getUsername() == null) {
			return false;
		}
	...
	public int getTotalCount(int po_num, Criteria cri) {
		// TODO Auto-generated method stub
		return 0;
	}

	public int getTotalCount(int po_num) {
		// TODO Auto-generated method stub
		return 0;
	}
}